...
### Changed
- Removed phusion-openldap-builder, phusion-ruby-builder and phusion-ruby-fips.
  Removed references to general Phusion. Removed with references to them:
  openssl-builder, postgres-client-builder and ubuntu-ruby-builder.
